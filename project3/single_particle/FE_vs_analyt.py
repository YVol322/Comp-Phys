...
file = open("/Users/JVol/Documents/GitHub/comp-phys/project3/single_particle/FE_sol_4k.csv")
type(file)
...
file = open("/Users/JVol/Documents/GitHub/comp-phys/project3/single_particle/FE_sol_8k.csv")
type(file)
csvreader=csv.reader(file)
header = []
header = next(csvreader)
...
file = open("/Users/JVol/Documents/GitHub/comp-phys/project3/single_particle/FE_sol_16k.csv")
type(file)
csvreader=csv.reader(file)
header = []
header = next(csvreader)
...
file = open("/Users/JVol/Documents/GitHub/comp-phys/project3/single_particle/FE_sol_32k.csv")
type(file)
csvreader=csv.reader(file)
header = []
header = next(csvreader)
